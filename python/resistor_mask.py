...
#band_crop, debug_img = ct.isolate_band_region('archive/1K_1-4W/1K_1-4W_(2).jpg')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--input', help='Path to input image.', default=ct.isolate_band_region('archive/1K_1-4W/1K_1-4W_(2).jpg'))
